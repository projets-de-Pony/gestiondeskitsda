...
describe('ECBMode', () => {
    it('encrypt', () => {
        const modeOfOperation = new src_1.ECBMode();
        (0, testSrc_1.expect)(modeOfOperation.startEncryption()).to.be.deep.equal(new Uint8Array());
        ...
        (0, testSrc_1.expect)(encrypted1).to.be.deep.equal(block1);
        (0, testSrc_1.expect)(encrypted2).to.be.deep.equal(block2);
        (0, testSrc_1.expect)(encrypted3).to.be.deep.equal(block3);
