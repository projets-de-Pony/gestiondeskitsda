...
exports.setInitialAdminClaims = exports.setAdminClaims = exports.createFirstAdmin = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
admin.initializeApp();
const SUPER_ADMIN_CODE = 'SITEDA2025SUPER';
exports.createFirstAdmin = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        if (data.superAdminCode !== SUPER_ADMIN_CODE) {
            ...
            throw new functions.https.HttpsError('permission-denied', 'Code super admin incorrect');
        }
        ...
        if (!data.email || !data.password || !data.name) {
            ...
            throw new functions.https.HttpsError('invalid-argument', 'Email, mot de passe et nom requis');
        }
        ...
        if (!adminSnapshot.empty) {
            ...
            throw new functions.https.HttpsError('failed-precondition', 'Un administrateur existe déjà');
        }
        // Créer l'utilisateur
        ...
        if (error instanceof Error) {
            throw new functions.https.HttpsError('internal', 'Erreur lors de la création du premier administrateur: ' + error.message);
        }
        else {
...
exports.setAdminClaims = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', 'Une erreur est survenue lors de la définition des claims admin');
    }
});
exports.setInitialAdminClaims = functions.https.onRequest(async (req, res) => {
