...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-24">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-12">
              Des solutions numériques sur mesure pour propulser votre entreprise vers le succès
            </p>
