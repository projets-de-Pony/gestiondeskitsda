  ...
  return (
    <Router>
      <div className="min-h-screen bg-white text-gray-900">
        <Routes>
          {/* Routes d'administration sans Navbar */}
          ...
          <Route path="/*" element={
            <>
              ...
              <Routes>
                ...
                <Route path="/shop/products/:id" element={<><ProductDetail /><Footer /></>} />
                <Route path="/conference-registration" element={<><ConferenceRegistration /><Footer /></>} />
                <Route path="/checkout" element={<><Checkout /><Footer /></>} />
                <Route path="/order-confirmation" element={<><OrderConfirmation /><Footer /></>} />
              </Routes>
            </>
          } />
        </Routes>
